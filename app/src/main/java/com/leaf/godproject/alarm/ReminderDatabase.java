...
public class ReminderDatabase extends SQLiteOpenHelper {
    ...
    private static final String KEY_ALARMTYPE = "alarmtype";
    private static final String KEY_ALARSTAT = "alarmstat";
    ...
    public int addReminder(Reminder reminder){
        ...
        values.put(KEY_ALARMTYPE, reminder.getAlarmtype());
        values.put(KEY_ALARSTAT , reminder.getAlarmstat());
    ...
    public List<Reminder> getAllReminders(){
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                reminder.setAlarmtype(cursor.getString(2));
                reminder.setAlarmstat(cursor.getString(3));
