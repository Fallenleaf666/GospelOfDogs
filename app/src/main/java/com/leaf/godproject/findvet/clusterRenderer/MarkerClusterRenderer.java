package com.leaf.godproject.findvet.clusterRenderer;
...
//        markerOptions.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN));
        markerOptions.icon(bitmapDescriptorFromVector(context1,R.drawable.vet));
    ...
    private class MyCustomClusterItemInfoView implements GoogleMap.InfoWindowAdapter {
        ...
        public View getInfoWindow(Marker marker) {
            ...
            TextView itemPhoneTextView = clusterItemView.findViewById(R.id.itemPhoneTextView);
...
//            itemPhoneTextView.setText(user.getPhone());
            itemPhoneTextView.setText((!user.getPhone().equals(" ")&&!user.getPhone().equals(""))
                    ?user.getPhone():" 未提供");
