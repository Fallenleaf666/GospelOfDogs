...
public class FindvetActivity5 extends AppCompatActivity implements OnMapReadyCallback, SearchView.OnQueryTextListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    private GoogleMap mMap;
    GoogleApiClient mGoogleApiClient;
    private static final int AUTOCOMPLETE_REQUEST_CODE = 22;
    private static final int REQUEST_LOCATION = 2;
    private static final String TAG = FindvetActivity5.class.getSimpleName();
...
//        啟用地理編碼
        geocoder = new Geocoder(FindvetActivity5.this, Locale.getDefault());
    }
...
//設置功能欄
    ...
    public void onMapReady(GoogleMap googleMap) {
        ProgressDialog progDialog = ProgressDialog.show(FindvetActivity5.this,
...
//        setupMyLocation();
        ...
        CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(FindvetActivity5.this);
