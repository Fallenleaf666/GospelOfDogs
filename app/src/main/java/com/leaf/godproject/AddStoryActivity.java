...
//                        String storyid = reference.push().getKey();
                        String storyid =FirebaseFirestore.getInstance().collection("Story")
                                .document(myid).collection("Stories")
                                .document().getId();
...
//                        reference.child(storyid).setValue(hashMap);
                        ...
                        Toast.makeText(AddStoryActivity.this, "失敗", Toast.LENGTH_SHORT).show();
                    }
                }
            ...
            Toast.makeText(AddStoryActivity.this, "尚未選取圖片", Toast.LENGTH_SHORT).show();
        }
    }
