...
public class Petdiary extends AppCompatActivity implements View.OnClickListener {
            ...
            db.collection("Discusses").document("Discuss")
                    ...
                    .addOnSuccessListener(new OnSuccessListener() {
                        ...
                        public void onSuccess(Object o) {
                            Toast.makeText(Petdiary.this, "新增成功", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(Petdiary.this, "新增失敗", Toast.LENGTH_SHORT).show();
                            loadingProgressBar.setVisibility(View.GONE);
                        }
                    });
        }
